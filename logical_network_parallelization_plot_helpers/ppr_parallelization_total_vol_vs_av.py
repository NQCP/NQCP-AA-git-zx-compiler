...
LOGICAL_BLOCKS_JSON = f"{input_dir}/logical_blocks_{circuit}.jsonl.gz"
OUTPUT_FILE = f"{output_dir}/ppr_parallelization_total_vol_vs_av.pdf"
...
def schedule_sequences(sequences, total_capacity=TOTAL_LOGICAL_BLOCKS):
    ...
    Returns (cycle, num_parallel_ops, used_blocks)."""
    remaining = deque(
